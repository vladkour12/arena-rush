          ...
          if (aimVec) {
             ...
             if (aimMagnitude > 0.1) {
                 ...
                 if (snapTarget) {
                     ...
                     if (AIM_SNAP_AUTO_FIRE && aimMagnitude > 0.3) {
                         firing = true;
                     }
                 }
